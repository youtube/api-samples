	...
	if args.language:
		for language in update_result['localizations']:
			...
			if language.lower() == args.language.lower():
				...
				print(f'Updated channel section {args.channel_section_id} localized title to {localization["title"]} in \'{args.language}\'.')
			break

	if (args.default_language and
		args.default_language == update_result['snippet']['defaultLanguage']):
		print(f'Updated default language to {args.default_language}.')
...
def get_channel_section_localization(youtube, args):
	...
	print(f'The channel section\'s title is \'{localized["title"]}\' in language \'{args.language}\'.')
...
def list_channel_section_localizations(youtube, args):
	...
	for language, localization in localizations.iteritems():
		print(f'The channel section title is \'{localization["title"]}\' in language \'{language}\'.')
	else:
