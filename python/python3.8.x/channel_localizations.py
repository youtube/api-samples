...
def set_channel_localization(youtube, args):
	...
	if args.default_language:
		...
		print(f'Updated language to {updated_default_language}')
	...
	print(f"Updated channel {args.channel_id} localized title and description to '{localization['title']}' and '{localization['description']}' in language '{args.language}'")
...
def get_channel_localization(youtube, channel_id, language):
	...
	print(f"Channel description is {localized['description']} in language {language}")
...
def list_channel_localizations(youtube, channel_id):
	...
	if 'localizations' in results['items'][0]:
		...
		for language, localization in localizations.iteritems():
			print(f'Channel description is {localization["description"]} in language {language}')
		else:
