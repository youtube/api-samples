...
def get_comments(youtube, parent_id):
    ...
    for item in results["items"]:
        ...
        print(f"Comment by {author}: {text}" % (author, text))
...
def insert_comment(youtube, parent_id, text):
    ...
    print(f"Replied to a comment for {author}: {text}")
...
def update_comment(youtube, comment):
    ...
    print(f"Updated comment for {author}: {text}")
...
def set_moderation_status(youtube, comment):
    ...
    print(f"{comment['id']} moderated succesfully")
...
def mark_as_spam(youtube, comment):
    ...
    print(f"{comment['id']} marked as spam succesfully")
...
def delete_comment(youtube, comment):
    ...
    print(f"{comment['id']} deleted succesfully")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"An HTTP error {e.resp.code} occurred:\n{e.content}")
    else:
