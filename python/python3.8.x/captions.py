...
def upload_caption(youtube, video_id, language, name, file):
	...
	print(f"Uploaded caption track '{name}({id}) in '{language}' language, '{status}' status.")
...
def update_caption(youtube, caption_id, file):
	...
	print(f"Updated caption track '{name}' draft status to be: '{isDraft}'")
	if file:
...
def download_caption(youtube, caption_id, tfmt):
	...
	print(f"First line of caption track: {subtitle}")
...
def delete_caption(youtube, caption_id):
	...
	print(f"caption track '{caption_id}' deleted succesfully")
