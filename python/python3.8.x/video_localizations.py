	...
	if args.language:
		for language in update_result['localizations']:
			...
			if language.lower() == args.language.lower():
				...
				print(f'''Updated video \'{args.video_id}\' localized title to \'{localization["title"]}\''
						' and description to \'{localization["description"]}\' in language \'{args.language}\'''')
				break
...
def get_video_localization(youtube, args):
	...
	print(f'Video title is \'{localized["title"]}\' and description is \'{localized["description"]}\' in language \'{args.language}\'')
...
def list_video_localizations(youtube, args):
	...
	if 'localizations' in results['items'][0]:
		...
		for language, localization in localizations.iteritems():
			print(f'Video title is \'{localization["title"]}\' and description is \'{localization["description"]}\' in language \'{language}\'')
	else:
