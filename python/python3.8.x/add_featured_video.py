...
def get_authenticated_service(args):
	flow = InstalledAppFlow.from_client_secrets_file(CLIENT_SECRETS_FILE, scope=YOUTUBE_SCOPE,
...
if __name__ == '__main__':
	...
	try:
		...
		print(f"An HTTP error {e.resp.status} occurred:\n{e.content}" % (e.resp.status, e.content))
	else:
		print(f"Added featured video {args.video_id} to channel {args.channel_id}.")
