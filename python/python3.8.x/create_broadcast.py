...
def insert_broadcast(youtube, options):
    ...
    print(f"Broadcast '{insert_broadcast_response['id']}' with title '{snippet['title']}' was published at '{snippet['publishedAt']}'.")
...
def insert_stream(youtube, options):
    ...
    print(f"Stream '{insert_stream_response['id']}' with title '{snippet['title']}' was inserted.")
...
def bind_broadcast(youtube, broadcast_id, stream_id):
    ...
    print(f"Broadcast '{bind_broadcast_response['id']}' was bound to stream '{bind_broadcast_response['contentDetails']['boundStreamId']}'.")
